...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-sm text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary100 text-primary-foreground shadow hover:bg-primary/90",
        defaultOutline:
          "border border-primary100 text-primary100 hover:text-primary-foreground hover:bg-primary100 shadow-sm ",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",
        outline:
          "border border-[#6934D31A] bg-background shadow-sm hover:bg-accent hover:text-accent-foreground",
        secondary:
